...
namespace WindBot.Game.AI.Decks
{
    ...
    public class GodExecutor : DefaultExecutor
    {
        ...
        {
            if (Bot.Deck.Count >=((AI.Utils.Enemy.LifePoints - Bot.LifePoints)/2000) && Bot.LifePoints>1000 && !Bot.HasInHand(CardId.UpstartGoblin)&&!Bot.HasInHand(CardId.ChickenGame) && !AI.Utils.ChainContainsCard(CardId.UpstartGoblin)&&!AI.Utils.ChainContainsCard(CardId.ChickenGame))
            {
